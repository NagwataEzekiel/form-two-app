...
function AskQuestion({ props }) {
	...
	return (
		<div>
			<Toolbar post="Upload a Story" drawerClickHandler={drawerToggleClickHandler} />

			<SideDrawer post="Upload a Story" posts="Posts" user="Lookbook" show={SideDrawerOpen} />
			{backdrop}
				...
				<div className="text-container">
					<ScrollView style={{width:'100%', height:'100%'}}>
						<div className="about__content">
							<h2>Welcome to Form White Platform</h2>
							<p>
							...
							<ul>
								...
								<li>
									In the Ask question page, users are expected to type in their question and add an
